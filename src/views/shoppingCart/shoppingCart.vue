  ...
  <div class="contain">
          ...
          <div class="hb-panel">
            <div class="hb-panel-bd pb30">
              ...
              <div class="btn-default btn-s mt30"
                   ...
                   v-if="hasLoseEfficacyItem">清空失效培训内容
              </div>
            </div>

            <div class="loading-tips" v-if="shoppingCartTotalSize<pager.pageSize"><span class="line"></span><span
              class="txt">已经到最底部啦</span><span class="line"></span>
            </div>
            <div class="loading-tips"
                 v-if="shoppingCartTotalSize>=pager.pageSize && scroller.pullupStatus === 'default'"><span
    ...
    <div class="hb-tabbar" v-if="shoppingCartList.length>0">
      ...
      <div class="hb-btn"
           ...
           :class="{'disabled':!checkHasChooseItem(shoppingCartList)}">{{showSettlementText}}
      </div>
      <!--不可操作-->
...
//            如果是加载更多已经加过请选择年度的就不用再加了
            if (item.optionYearList[0].name !== '请选择年度') {
