<template>
  <div class="container">
      ...
      <div class="js_dialog" id="iosDialog1" style="opacity: 1;">
        ...
        <div class="weui-dialog weui-dialog-1">
          ...
          <div class="weui-dialog__bd">亲，您存在
            <span class="cr"> {{needCompleteOrderList.length}}个 </span>订单需要完善配送信息，以便发票/证书的配送！
          </div>
    ...
    <!--培训证明-->
    <scroller class="hb-wrap-box" :height="scrollerHeight" lock-x scrollbar-y use-pulldown
