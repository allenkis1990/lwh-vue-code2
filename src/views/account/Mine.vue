<template>
  <div class="contain bg-w">
    ...
    <div class="hb-user-img">
      <img class="user-img" :src="imgUserHeader()" alt=" ">
    ...
    <div class="weui-cells hb-panel hb-personal-center">
      ...
      <div class="weui-cell weui-cell_access" v-if="isOpenCheckPhoneNumber" @click="jumpTo('changeTelephoneNum')">
        <div class="weui-cell__hd"><span class="hb-ico ico-phone"></span></div>
        <div class="weui-cell__bd">
          <div class="bd-items fs30">换绑手机</div>
        </div>
        <div class="weui-cell__ft"></div>
      </div>
    </div>
...
<script>
  ...
  //  import AppConstant from '../../global/constants/AppConstant'
  export default {
    components: { Group, Cell, CompleteOrderDialog },
    data () {
      return {
        isOpenCheckPhoneNumber: AppConstant.sysContext.isOpenCheckPhoneNumber,
