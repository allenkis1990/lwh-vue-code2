      ...
      <div class='weui-panel hb-panel mt0'>
        <div class='weui-cells weui-cells_form'>
          <div class='weui-cell'>
            ...
            <div class='weui-cell__bd'><input type='text' placeholder='请输入收件人' class='weui-input'
                                              v-model='receiptInfo.receiverName'></div>
          </div>
          <div class='weui-cell'>
            <div class='weui-cell__hd'><label class='weui-label weui-label-1'>手机号</label></div>
            <div class='weui-cell__bd'><input type='text' placeholder='请输入手机号' class='weui-input'
                                              v-model='receiptInfo.mobileNo'></div>
          </div>
          <div class='weui-cell weui-cell_select weui-cell_select-after height-40'>
            ...
            <div class='weui-cell__bd no-arrow'>
              <popup-picker class="gray-color poppicker-no-padding" placeholder="请选择所在地区" value-text-align='left'
          ...
          <div class='weui-cell weui-cell-start'>
            ...
            <div class='weui-cell__bd'><textarea placeholder='请输入收件详细地址' rows='3' class='weui-textarea'
                                                 v-model='receiptInfo.addressDetails'></textarea></div>
          </div>
          <div class='weui-cell'>
            <div class='weui-cell__hd'><label class='weui-label weui-label-1'
                                              v-model='receiptInfo.postalCode'>邮政编码</label></div>
            <div class='weui-cell__bd'><input type='text' placeholder='请输入邮政编码' class='weui-input'
                                              v-model='receiptInfo.postCode'></div>
          </div>
        </div>
      </div>
    </div>
