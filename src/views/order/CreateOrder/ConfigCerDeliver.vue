      ...
      <div class="tab-bd mt10" v-if="pageState.deliverType == 1">
        <div class="weui-panel hb-panel">
          <div class="weui-cells weui-cells_form">
            ...
            <popup-picker class="hb-area-box" placeholder="请选择收件地区" value-text-align="left" :title="areaTitle()"
            ...
            <div class="weui-cell weui-cell-start">
              ...
              <div class="weui-cell__bd">
                <textarea class="weui-textarea" placeholder="请填写收件详细地址" v-model="userAddressInfo.addressDetails"
                          rows="3"></textarea>
              </div>
            </div>
            <div class="weui-cell">
