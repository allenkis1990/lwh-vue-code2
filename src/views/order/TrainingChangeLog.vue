        ...
        <div class="hb-media-box hb-media-box-1" v-for="subItem in item.subOrderList" :key="subItem.subOrderNo">
          ...
          <div class="hb-media-box-bd">
            ...
            <div class="hb-media-box-desc">
              年度：{{getSkuValueWithKeyFromSkuArray('trainingYear',subItem.skuPropertyNameList)}}年
            </div>
            <div class="hb-media-box-desc">
              科目：{{getSkuValueWithKeyFromSkuArray('trainingSubject',subItem.skuPropertyNameList)}}
            </div>
