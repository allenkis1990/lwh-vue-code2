<template>
  <div class="contain">
    ...
    <div class="hb-header-box">
      <div class="header-tit">[2019年度][初级]必修课程</div>
    ...
    <!--班级列表-->
    <div class="hb-wrap-box-4" style="padding-bottom:2rem;">
      <div class="hb-panel">
    ...
    <div class="hb-tabbar">
      <div class="left-box flex e-course-tab-left">
        <div class="text2">共X门课程，共X学分。其中公需科目X学分，专业科目Y学分</div>
        <div class="pic"><img src="../images/icon-go-bgbase-down.png" /></div>
      </div>
      <div class="hb-btn">查看课程结构</div>
      <!--不可操作-->
